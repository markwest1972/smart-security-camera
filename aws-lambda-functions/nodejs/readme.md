# Node.js based aws-lambda-functions

This directory contains Node.js based AWS Lambda Function definitions used by the smart-security-camera project.  [Java versions are also available]().
